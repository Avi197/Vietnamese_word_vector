...
# raw data
Vnn = 'H:/Vietnamese word representations/Raw news data (duplicates removed)/word_vectors/vnn.json'
Vnexpress = 'H:/Vietnamese word representations/Raw news data (duplicates removed)/word_vectors/vnexpress.json'
Thanhnien = 'H:/Vietnamese word representations/Raw news data (duplicates removed)/word_vectors/thanhnien.json'
Dantri = 'H:/Vietnamese word representations/Raw news data (duplicates removed)/word_vectors/dantri.json'
Tuoitre = 'H:/Vietnamese word representations/Raw news data (duplicates removed)/word_vectors/tuoitre.json'
Vtv = 'H:/Vietnamese word representations/Raw news data (duplicates removed)/word_vectors/vtv.json'
...
Vtv_data = 'H:/Vietnamese word representations/Word_vector_data/json data/Vtv/vtv_data.json'


# text data
# ---------
# windows
Dantri_text = 'H:/Vietnamese word representations/Word_vector_data/text data/dantri_data'
Thanhnien_text = 'H:/Vietnamese word representations/Word_vector_data/text data/thanhnien_data'
Tuoitre_text = 'H:/Vietnamese word representations/Word_vector_data/text data/tuoitre_data'
